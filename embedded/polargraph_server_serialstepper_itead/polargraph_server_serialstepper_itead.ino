...
int const PEN_HEIGHT_SERVO_PIN = A0;
...
//  pinMode(motoraMicrostep1, OUTPUT);
//  pinMode(motoraMicrostep2, OUTPUT);
//
//  pinMode(motorbMicrostep1, OUTPUT);
//  pinMode(motorbMicrostep2, OUTPUT);
//  
//  digitalWrite(motoraMicrostep1, HIGH);
//  digitalWrite(motoraMicrostep2, HIGH);
//
//  digitalWrite(motorbMicrostep1, HIGH);
//  digitalWrite(motorbMicrostep2, HIGH);
...
void test()
{
  ...
  changeLength(5000.0F, 5000.0F);
  changeLength(0.0F, 0.0F);
...
//      Serial.println(maxDens);
  ...
  void testPenWidthScribble()
  {
    ...
    long posA = motora.currentPosition();
    long posB = motorb.currentPosition();
...
//  motora.moveTo(intPos);
//  intPos = (int)(tB+0.5);
//  motorb.moveTo(intPos);
...
void drawSquarePixel() 
{
    ...
    if (globalDrawDirectionMode == DIR_MODE_AUTO)
      globalDrawDirection = getAutoDrawDirection(originA, originB, motora.currentPosition(), motorb.currentPosition());

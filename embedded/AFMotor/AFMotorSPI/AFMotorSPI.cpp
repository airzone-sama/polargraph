...
inline void initPWM1(uint8_t freq) {
    ...
    // use PWM from timer2A on PB3 (Arduino pin #11)  ///   AMEND TO USE timer1A on PB1 (arduino pin #9) - this sacrifices the servo driver on that pin.
...
inline void setPWM1(uint8_t s) {
    ...
    //OCR2A = s;
    OCR1A = s; // changed to use pwm from timer1A arduino pin 9 / pb1
#elif defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)
    // on arduino mega, pin 11 is now PB5 (OC1A)
    OCR1A = s;
#else

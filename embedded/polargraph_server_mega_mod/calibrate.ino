...
{
  Michael_SerialPrintln("Doing calibration.");
  // raise pen
  penlift_penUp();
  // turn motors off
  releaseMotors();
  ...
  Michael_SerialPrintln("A End stop signalled");
  ...
  Michael_SerialPrintln("B End stop signalled");
